...
<body onload="odliczanie();">
  ...
  ?>
	...
	<div id="srodek">
		...
		<div id="aside">
			<div id="picture">
				<img src="Obrazki\kursy41.jpg" alt="kursy">
			</div>
		</div>
		...
		<br><br><p><b>«Гештальт-Подход, Начало»</b></p>
			...
			<p>Всем привет! Набираю группу на первую ступень «Гештальт-подход.» По окончанию программы, Вы получаете сертификат о прохождении данного курса (МГИ - Московского Гештальт Института)</p>
			<p>Жить Жизнь «Здесь и Сейчас», не откладывая её «на потом». Формат группы: терапевтически-обучающий.
			<p> Эта группа для тех, кто хочет узнать о себе! Для тех, кто хочет увеличить свои знания в психологии! Для тех, кто хочет улучшить качество своей жизни, перестать страдать и начать жить счастливо, радуясь каждому дню «Здесь и Сейчас»

			<p>Формат группы: терапевтически-обучающий, т.е. на наших встречах мы будем «прорабатывать» Вашу целостность, кирпичик за кирпичиком выстраивать Вашу личность. Также, кто захочет двигаться дальше и получить возможность консультировать самостоятельно, развиваться в психологии, смогут пойти на 2-ю обучающую ступень.

			<p>По желанию, после 1-й ступени (9 встреч по 16 часов каждая) можно получить сертификат о прохождении курса.
			</p>
