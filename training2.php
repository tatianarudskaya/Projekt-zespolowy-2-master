...
<body onload="odliczanie();">
  ...
  ?>
	...
	<div id="srodek">
		...
		<div id="aside">
			<div id="picture">
				<img src="Obrazki\kursy2.jpg" alt="kursy">
			</div>
		</div>
		...
		<br><br><p><b>Женская Группа «Психология Отношений»</b></p>
			...
			<p>Наш второй WorkShop на котором мы с Вами запустим волшебные изменения Вашей жизни. Живи ярко и комфортно!</p>
			<p>Пришла пора исправлять устоявшиеся негативные убеждения. Они называются паттерны поведения — это собственные убеждения о жизни, о самом себе, об окружающих людях, которые вылетают «на автомате». Изменять необходимо именно те убеждения, которые мешают чувствовать себя хорошо.
			<p>Коррекция устоявшихся убеждений, мешающих жить по другому, – это одна из приоритетных задач нашего Курса, который пройдет в Бресте 6 Октября по адресу: ул.Советская 83, каб.107
			<p>Количество участников ограничено. Пожалуйста, заранее позаботьтесь о себе и о месте в группе, запишитесь чтобы принять участие
			<p>Настало время сделать Вашу жизнь не только стабильной, но и комфортной.</p>
			</p>
