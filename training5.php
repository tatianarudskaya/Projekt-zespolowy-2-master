...
<body onload="odliczanie();">
  ...
  ?>
	...
	<div id="srodek">
		...
		<div id="aside">
			<div id="picture">
				<img src="Obrazki\kursy1.jpg" alt="kursy">
			</div>
		</div>
		...
		<br><br><p><b>Женская интересная группа</b></p>
		
			<p>Целую неделю на глаза попадаются мои тренинги, которые я уже когда-то проводила на тему женственности, женской сексуальности, отношений, принятия себя и так далее.

			<p>В этой встрече я решила объединить несколько тренингов  в один. И получилась очень целая картинка.

			<p>Приглашаю девушек и женщин

			<p>- Поисследовать себя. Понять, что заложено в нас природой, а что является качествами навеянные социумом.
			<p>- Научимся принимать свою женственность в разном возрасте
			<p>- Узнаем какие женские роли Вы используете в жизни
			<p>- Проанализируем какими Вас видят окружающие
			<p>- Напишем свою собстенную сказку и составим план дальнейших действий.
			<p>- Составим карту желаний.
			<p>Будем работать с Метафорическими картами, и использовать арт-терапевтические техники.

			<p>Будет очень интересно и познавательно!)
			</p>
